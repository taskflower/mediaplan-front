  ...
  return (
    <div className="px-4">
      <div className="container mx-auto mb-8">
        <div className="sm:pt-12 sm:bg-gray-950 sm:rounded-t-2xl sm:min-h-24">
          <div className="w-full flex flex-col text-gray-50">
            <div className="flex flex-col grow justify-start p-4 sm:p-6 md:p-12 w-full mx-auto max-w-5xl">
              <div className="w-full flex flex-col gap-0.5 ">
                {/* Hero section */}
                <div className="mb-6 text-center">
                  <h1 className="text-4xl sm:text-8xl font-black">
                    ADS KING 
                  </h1>
        ...
        <svg
          ...
          className="w-full hidden sm:block fill-gray-950"
        >
      ...
      <Card>
        <div className="text-center">
          ...
          <p className="mb-6">
            Wypróbuj naszą darmową analizę strony internetowej i przekonaj się o
            możliwościach AI w marketingu.
          </p>
